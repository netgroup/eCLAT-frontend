    ...
    <section class="section">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 col-12 mt-4 pt-2">
            <div
              class="card border-0 work-container work-modern position-relative d-block overflow-hidden rounded-0"
            >
              <div class="card-body p-0">
                <img
            ...
            <div class="card job-box rounded shadow border-0 overflow-hidden">
              <div class="border-bottom">
                ...
                <h5 class="mb-0 position">
                  <router-link to="/page-job-detail" tag="a" class="text-dark"
              ...
              <div class="card-body">
                ...
                <div class="content text-center">
                  ...
                  <span class="text-muted"
                    ...
                    ></i
                    >Experience <span class="text-success">3+ years</span></span
                  >
              ...
              <div class="p-4">
                ...
                <ul class="list-unstyled mb-4">
                  <li class="h6">
                    ...
                    ><span class="text-muted">Location :</span> San Francisco
                  </li>
                  <li class="h6">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    >
                      ...
                      ></path></svg
                    ><span class="text-muted">Comapny :</span> circleci.com
                  </li>
                  <li class="h6">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    >
                      ...
                      ></path></svg
                    ><span class="text-muted">Revenue :</span> $ 5M / Annual
                  </li>
                  <li class="h6">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    ><span class="text-muted">No. of employees :</span> 200
                  </li>
                </ul>
                <router-link
                  tag="a"
          ...
          <div class="col-lg-5 mt-4 pt-2">
            <div class="card event-schedule rounded border">
              <div class="card-body">
                <div class="media">
                  <ul
                    class="date text-center text-primary mr-3 mb-0 list-unstyled"
                  >
