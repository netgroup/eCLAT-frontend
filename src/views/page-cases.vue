        ...
        <div class="row">
          ...
          >
            ...
            <li class="list-inline-item">
              <a
                class="categories border d-block text-dark rounded"
                @click="updateFilter('Business')"
                :class="{ active: filterCategory == 'Business' }"
                >Business</a
              >
            </li>
            <li class="list-inline-item">
              <a
                class="categories border d-block text-dark rounded"
                @click="updateFilter('Marketing')"
                :class="{ active: filterCategory == 'Marketing' }"
                >Marketing</a
              >
            </li>
            <li class="list-inline-item">
              <a
                ...
                :class="{ active: filterCategory == 'Finance' }"
                >Finance</a
              >
            </li>
            <li class="list-inline-item">
              <a
                class="categories border d-block text-dark rounded"
                @click="updateFilter('HR')"
                :class="{ active: filterCategory == 'HR' }"
                >Human Research</a
              >
            </li>
          </ul>
