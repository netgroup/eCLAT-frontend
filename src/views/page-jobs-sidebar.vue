                ...
                <div class="mt-4">
                  <div class="custom-control custom-radio">
                    <div class="form-group mb-2">
                      ...
                      />
                      <label class="custom-control-label" for="lasthour"
                        >Last Hour</label
                      >
                    </div>
                  </div>
                  ...
                  <div class="custom-control custom-radio">
                    <div class="form-group mb-2">
                      <input
                        ...
                        class="custom-control-input"
                      />
                      <label class="custom-control-label" for="oneday"
                        >Last 24 hours</label
                      >
                    </div>
                  </div>
                  ...
                  <div class="custom-control custom-radio">
                    <div class="form-group mb-2">
                      <input
                        ...
                        class="custom-control-input"
                      />
                      <label class="custom-control-label" for="sevenday"
                        >Last 7 days</label
                      >
                    </div>
                  </div>
                  ...
                  <div class="custom-control custom-radio">
                    <div class="form-group mb-2">
                      <input
                        ...
                        class="custom-control-input"
                      />
                      <label class="custom-control-label" for="fourteenday"
                        >Last 14 days</label
                      >
                    </div>
                  </div>
                  ...
                  <div class="custom-control custom-radio">
                    <div class="form-group mb-0">
                      <input
                        ...
                        class="custom-control-input"
                      />
                      <label class="custom-control-label" for="onemonth"
                        >Last 30 days</label
                      >
                    </div>
                  </div>
                  ...
                  <div class="form-group mb-2">
                    <div class="custom-control custom-checkbox">
                      <input
                        ...
                        id="fulltime"
                      />
                      <label class="custom-control-label" for="fulltime"
                        >Full Time</label
                      >
                    </div>
                  </div>
                  ...
                  <div class="form-group mb-0">
                    <div class="custom-control custom-checkbox">
                      <input
                        ...
                        id="intership"
                      />
                      <label class="custom-control-label" for="intership"
                        >Intership</label
                      >
                    </div>
                  </div>
                  ...
                  <div class="custom-control custom-radio">
                    <div class="form-group mb-2">
                      <input
                        ...
                        class="custom-control-input"
                      />
                      <label class="custom-control-label" for="freshers"
                        >Fresher</label
                      >
                    </div>
                  </div>
                  ...
                  <div class="custom-control custom-radio">
                    <div class="form-group mb-2">
                      <input
                        ...
                        class="custom-control-input"
                      />
                      <label class="custom-control-label" for="oneyearex"
                        >+1 Year</label
                      >
                    </div>
                  </div>
                  ...
                  <div class="custom-control custom-radio">
                    <div class="form-group mb-2">
                      <input
                        ...
                        class="custom-control-input"
                      />
                      <label class="custom-control-label" for="twoyearex"
                        >+2 Year</label
                      >
                    </div>
                  </div>
                  ...
                  <div class="custom-control custom-radio">
                    <div class="form-group mb-2">
                      <input
                        ...
                        class="custom-control-input"
                      />
                      <label class="custom-control-label" for="threeyearex"
                        >+3 Year</label
                      >
                    </div>
                  </div>
                  ...
                  <div class="custom-control custom-radio">
                    <div class="form-group mb-0">
                      <input
                        ...
                        class="custom-control-input"
                      />
                      <label class="custom-control-label" for="fiveyearex"
                        >+5 Year</label
                      >
                    </div>
                  </div>
          ...
          <div class="col-lg-8 col-md-6 col-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
            <div class="row">
              <div class="col-lg-6 col-12 mb-4 pb-2">
                <div
                  class="card job-box rounded shadow border-0 overflow-hidden"
                >
              ...
              <div class="col-lg-6 col-12 mb-4 pb-2">
                ...
                >
                  <div class="border-bottom">
                    ...
                    <h5 class="mb-0 position">
                      <router-link to="/page-job-detail" class="text-dark"
                        >Back-End Developer</router-link
                      >
                      <ul class="list-unstyled h6 mb-0 text-warning">
                        <li class="list-inline-item mb-0">
                          <i class="mdi mdi-star"></i>
              ...
              <div class="col-lg-6 col-12 mb-4 pb-2">
                ...
                >
                  <div class="border-bottom">
                    ...
                    <h5 class="mb-0 position">
                      <router-link to="/page-job-detail" class="text-dark"
                        >Frontend Developer</router-link
                      >
                      <ul class="list-unstyled h6 mb-0 text-warning">
                        <li class="list-inline-item mb-0">
                          <i class="mdi mdi-star"></i>
