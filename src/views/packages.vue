...
<template>
  <div>
        ...
        <div class="row justify-content-center">
          <div class="col-lg-12 text-center">
            <div class="page-next-level">
              <h4 class="title">
                There are {{ packages.length }} available packages
              </h4>
    ...
    <div :key="p._id" v-for="p in packages">
      <!-- v-show="p.releases.length ? true : false"  used to show only packages that have at least one release-->
